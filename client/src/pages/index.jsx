...
const index = () => {
  return (
    <>
            ...
            <div class="container">
              <div class="topbar-left xs-hide">
                <div class="topbar-widget">
                  ...
                  <div class="topbar-widget">
                    <a href="#">
                      <i class="fa fa-envelope"></i>contact@rentaly.com
                    </a>
                  </div>
                  <div class="topbar-widget">
                    <a href="#">
                ...
                <div class="de-flex sm-pt10">
                  ...
                  <div class="de-flex-col header-col-mid">
                    <ul id="mainmenu">
                      ...
                      <li>
                        <a class="menu-item" href="quick-booking.html">
                          Booking
                        </a>
                        <ul>
                          <li>
                      ...
                      <li>
                        ...
                        <ul>
                          ...
                          <li>
                            <a class="menu-item" href="register.html">
                              Register
                            </a>
                          </li>
                          <li>
                            <a class="menu-item" href="404.html">
                              Page 404
                            </a>
                          </li>
                        </ul>
                      ...
                      <li>
                        ...
                        <ul>
                          ...
                          <li>
                            <a class="menu-item" href="badge.html">
                              Badge
                            </a>
                          </li>
                          <li>
                            <a class="menu-item" href="counters.html">
                              Counters
                            </a>
                          </li>
                          <li>
                          ...
                          <li>
                            <a class="menu-item" href="modal.html">
                              Modal
                            </a>
                          </li>
                          <li>
                            <a class="menu-item" href="popover.html">
                              Popover
                            </a>
                          </li>
                          <li>
                            <a class="menu-item" href="tabs.html">
                              Tabs
                            </a>
                          </li>
                          <li>
                            <a class="menu-item" href="tooltips.html">
                              Tooltips
                            </a>
                          </li>
                        </ul>
                  ...
                  <div class="de-flex-col">
                    <div class="menu_side_area">
                      <a href="login.html" class="btn-main">
                        Sign In
                      </a>
            ...
            <div class="container">
              <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                  ...
                  &nbsp;&nbsp;&nbsp;
                  <a class="btn-main btn-black" href="#">
                    Get the App
                  </a>
                </div>
                ...
                <div id="items-carousel" class="owl-carousel wow fadeIn">
                  <div class="col-lg-12">
                    <div class="de-item mb30">
                      <div class="d-img">
                        <img
                          src="/assets/images/cars/jeep-renegade.jpg"
                          class="img-fluid"
                          alt=""
                        />
                      </div>
                      <div class="d-info">
                        <div class="d-text">
                          ...
                          <div class="d-atr-group">
                            ...
                            <span class="d-atr">
                              <img
                                src="/assets/images/icons/2-green.svg"
                                alt=""
                              />
                              2
                            </span>
                  ...
                  <div class="col-lg-12">
                    <div class="de-item mb30">
                      <div class="d-img">
                        <img
                          src="/assets/images/cars/bmw-m5.jpg"
                          class="img-fluid"
                          alt=""
                        />
                      </div>
                  ...
                  <div class="col-lg-12">
                    <div class="de-item mb30">
                      <div class="d-img">
                        <img
                          src="/assets/images/cars/ferrari-enzo.jpg"
                          class="img-fluid"
                          alt=""
                        />
                      </div>
                  ...
                  <div class="col-lg-12">
                    <div class="de-item mb30">
                      <div class="d-img">
                        <img
                          src="/assets/images/cars/ford-raptor.jpg"
                          class="img-fluid"
                          alt=""
                        />
                      </div>
                  ...
                  <div class="col-lg-12">
                    <div class="de-item mb30">
                      <div class="d-img">
                        <img
                          src="/assets/images/cars/mini-cooper.jpg"
                          class="img-fluid"
                          alt=""
                        />
                      </div>
                  ...
                  <div class="col-lg-12">
                    <div class="de-item mb30">
                      <div class="d-img">
                        <img
                          src="/assets/images/cars/vw-polo.jpg"
                          class="img-fluid"
                          alt=""
                        />
                      </div>
                ...
                <div class="col-md-4">
                  <div class="de-image-text">
                    <div class="d-text">
                      ...
                      <blockquote>
                        I have been using Rentaly for my Car Rental needs for
                        over 5 years now. I have never had any problems with
                        their service. Their customer support is always
                        responsive and helpful. I would recommend Rentaly to
                        anyone looking for a reliable Car Rental provider.
                ...
                <div class="col-md-4">
                  <div class="de-image-text">
                    <div class="d-text">
                      ...
                      <h4>Excellent Service! Car Rent Service!</h4>
                      <blockquote>
                        We have been using Rentaly for our trips needs for
                        several years now and have always been happy with their
                        service. Their customer support is Excellent Service!
                        and they are always available to help with any issues we
                        have. Their prices are also very competitive.
              ...
              <div class="row g-custom-x force-text-center">
                <div class="col-md-3 col-sm-6 mb-sm-30">
                  <div class="de_count wow fadeInUp">
                    ...
                    Trips Powered
                    <p class="d-small">
                      Lorem ipsum adipisicing officia in adipisicing do velit
                      sit tempor ea consectetur.
                    </p>
                  </div>
                </div>
                <div class="col-md-3 col-sm-6 mb-sm-30">
      ...
      <div id="purchase-now">
        <a
          href="https://themeforest.net/cart/configure_before_adding/44940477"
          target="_blank"
        >
          <span>$</span>25
        </a>
